...
if (!isset($_SESSION["host_sessionid"]) || $_SESSION["host_sessionid"]=="") {
    $_SESSION["host_sessionid"] = date("YmdHis").rand(10,99);
    $Sql = 'INSERT INTO '.$db["dbname"].'.session (sessionid,date,device_info,ip) VALUES ("'.
                $_SESSION["host_sessionid"].'" , now() ,"'.$_SERVER['HTTP_USER_AGENT'].'" , "'.
